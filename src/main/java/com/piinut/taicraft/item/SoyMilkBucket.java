...
public class SoyMilkBucket extends BucketItem {

    public SoyMilkBucket(Supplier<? extends Fluid> supplier, Properties builder) {
    ...
    public ItemStack finishUsingItem(ItemStack stack, World p_77654_2_, LivingEntity livingEntity) {
        if (!p_77654_2_.isClientSide) livingEntity.curePotionEffects(new ItemStack(Items.MILK_BUCKET)); // FORGE - move up so stack.shrink does not turn stack into air
